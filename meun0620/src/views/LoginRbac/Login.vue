<template>
  ...
  <el-form-item label="" prop="Verification2">
<el-col :span="5">
...
<script>
  export default {
    ...
    methods: {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            if(this.ruleForm.Verification!=this.ruleForm.Verification2){
              ...
              this.$http.post("https://localhost:44343/api/LoginServer/GetLogin",this.ruleForm).then(res=>{
                let infor  = res.data;
                 if(infor.erSum > 0){
      ...
      GetRandom(){
        this.$http.get("https://localhost:44343/api/LoginServer/GetRandom").then(res=>{
